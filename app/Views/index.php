            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?= base_url()?>/index.php" class="logo"><i class="md md-terrain"></i> <span>Moltran </span></a>
                    </div>
                </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="<?= base_url()?>/#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><?//php echo $prenom .' '. $nom?> Mamzo <span class="caret"></span></a>
