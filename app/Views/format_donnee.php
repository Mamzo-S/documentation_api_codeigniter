        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="<?= base_url() ?>index" class="logo"><i class="md md-terrain"></i> <span>Moltran </span></a>
                </div>
            </div>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="active"><a href="<?= base_url() ?>endpoints">Endpoints</a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="pull-left page-title">Format de donnee</h4>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nouveau format</h4>
                    </div>
                    <div class="modal-body">
                        <form action="<?= base_url('AjoutFormat') ?>" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="field-2" class="control-label">Format de donnee</label>
                                        <input type="text" class="form-control" id="field-2" name="format">
                                    </div>
                                </div>
                            </div>
        ...
        <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">Modification d'un format</h4>
                    </div>
                    <div class="modal-body">
                        <form action="<?= base_url('EditFormat') ?>" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
