	...
	$.extend( $.fn.dataTableExt.oPagination, {
		"bs_normal": {
			"fnInit": function( oSettings, nPaging, fnDraw ) {
				...
				$(nPaging).append(
					'<ul class="pagination">'+
						'<li class="prev disabled"><a href="<?= base_url()?>/#"><span class="fa fa-chevron-left"></span></a></li>'+
						'<li class="next disabled"><a href="<?= base_url()?>/#"><span class="fa fa-chevron-right"></span></a></li>'+
					'</ul>'
				);
				var els = $('a', nPaging);
			...
			"fnUpdate": function ( oSettings, fnDraw ) {
				...
				for ( i=0, ien=an.length ; i<ien ; i++ ) {
					...
					for ( j=iStart ; j<=iEnd ; j++ ) {
						...
						$('<li '+sClass+'><a href="<?= base_url()?>/#">'+j+'</a></li>')
